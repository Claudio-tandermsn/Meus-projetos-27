...
function descriptografar() {
    ...
    /*A função "descriptografar" é chamada ao usuario clicar no botão "Descriptografar". O texto criptografado é obtido do 
...
/* O texto descriptografado é exibido no campo de texto com o id "text-cripto" e alguns elementos
